                        ...
                        <form action="{{ route('staff.sppd.store') }}" method="POST">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control @error('nomor_sppd') is-invalid @enderror" name="nomor_sppd" value="{{ old('nomor_sppd') }}" placeholder="Masukkan Nomor SPPD">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control @error('kode_no') is-invalid @enderror" name="kode_no" value="{{ old('kode_no') }}" placeholder="Masukkan Kode No.">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control @error('lembar_ke') is-invalid @enderror" name="lembar_ke" value="{{ old('lembar_ke') }}" placeholder="Masukkan Lembar Ke">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control @error('pangkat') is-invalid @enderror" name="pangkat" value="{{ old('pangkat') }}" placeholder="Cth: Penata Muda / III a">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control @error('tingkat_perjalanan') is-invalid @enderror" name="tingkat_perjalanan" value="{{ old('tingkat_perjalanan') }}" placeholder="Masukkan Tingkat Perjalanan">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-8">
                                    ...
                                    <input type="text" class="form-control @error('dasar_perintah_tugas') is-invalid @enderror" name="dasar_perintah_tugas" value="{{ old('dasar_perintah_tugas') }}" placeholder="Masukkan Dasar Surat Perintah">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="date" class="form-control @error('dasar_tanggal') is-invalid @enderror" name="dasar_tanggal" value="{{ old('dasar_tanggal') }}">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea name="maksud_perjalanan" class="form-control @error('maksud_perjalanan') is-invalid @enderror" rows="3" placeholder="Masukkan Maksud Perjalanan Dinas">{{ old('maksud_perjalanan') }}</textarea>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('alat_angkutan') is-invalid @enderror" name="alat_angkutan" value="{{ old('alat_angkutan') }}" placeholder="Cth: Kendaraan Dinas Roda 4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('lama_perjalanan') is-invalid @enderror" name="lama_perjalanan" value="{{ old('lama_perjalanan') }}" placeholder="Cth: 5 (Lima) Hari">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('tempat_berangkat') is-invalid @enderror" name="tempat_berangkat" value="{{ old('tempat_berangkat') }}" placeholder="Masukkan Tempat Berangkat">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('tempat_tujuan') is-invalid @enderror" name="tempat_tujuan" value="{{ old('tempat_tujuan') }}" placeholder="Masukkan Tempat Tujuan">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea name="pengikut" class="form-control @error('pengikut') is-invalid @enderror" rows="3" placeholder="Nama pengikut, jika ada. Pisahkan dengan baris baru.">{{ old('pengikut') }}</textarea>
                            ...
                            <div class="row mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('instansi_pembebanan') is-invalid @enderror" name="instansi_pembebanan" value="{{ old('instansi_pembebanan') }}" placeholder="Masukkan Instansi Pembebanan Anggaran">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea name="mata_anggaran" class="form-control @error('mata_anggaran') is-invalid @enderror" rows="2" placeholder="Masukkan Mata Anggaran">{{ old('mata_anggaran') }}</textarea>
